...
class UserStatsAggregatorTest(test_utils.GenericTestBase):
    ...
    def test_realtime_layer_batch_job_single_rating(self):
        ...
        self.assertEqual(user_stats['num_ratings'], 0)
        self.assertIsNone(user_stats['average_ratings'])
    ...
    def test_both_realtime_layer_and_batch_data(self):
        ...
        # two.
        self.assertEqual(user_stats['total_plays'], 14)
        self.assertEqual(user_stats['num_ratings'], 6)
        self.assertEqual(
            user_stats['average_ratings'], python_utils.divide(10, 3.0))
