...
class BeamEntityToAndFromModelTests(test_utils.TestBase):
    ...
    def test_get_ndb_model_from_beam_entity(self):
    ...
    def test_get_ndb_model_from_beam_entity_with_utc_tzinfo(self):
        ...
        self.assertEqual(
            CoreModel(
                id='abc', prop=123, created_on=utcnow, last_updated=None,
                deleted=False),
            job_utils.get_ndb_model_from_beam_entity(beam_entity))
