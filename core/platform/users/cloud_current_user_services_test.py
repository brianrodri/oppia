...
class GaeCurrentUserServicesTests(test_utils.GenericTestBase):
    ...
    def test_get_current_user(self):
        ...
        current_user = cloud_current_user_services.get_current_user()
        self.assertEqual(
            current_user,
            users.User(
    ...
    def test_get_current_gae_id(self):
        self.login(self.OWNER_EMAIL)
        user_id = cloud_current_user_services.get_current_gae_id()
        self.assertEqual(user_id, self.EXPECTED_OWNER_USER_ID)
        self.logout()
    ...
    def test_get_current_user_email(self):
        self.login(self.OWNER_EMAIL)
        email = cloud_current_user_services.get_current_user_email()
